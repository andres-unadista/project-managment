...
export const Projects = () => {
  ...
  return (
    <div>
            ...
            <div className="modal-body">
              <form onSubmit={handleSaveProject}>
                <div className="mb-3 text-start">
                  <label htmlFor="name" className="col-form-label fw-bold">Nombre del Proyecto</label>
                  <input
                    type="text"
                ...
                <div className="input-group mb-3">
                  <div className="input-group-prepend">
                    <label className="input-group-text" htmlFor="projectState">Estado del Proyecto</label>
                  </div>
                  <select
                ...
                <div className="input-group mb-3">
                  <div className="input-group-prepend">
                    <label className="input-group-text" htmlFor="projectState">Listado de Usuarios</label>
                  </div>
                  <select
                    className="custom-select"
                    name="id_user"
      ...
      <ProjectList /> {/* Asumiendo que ProjectList se encarga de mostrar la lista de proyectos */}
    </div>
  );
};
